...
- The behavior is test-covered (`test/activation-sampling.ts`, added in the same commit) — the first mechanics-adjacent unit tests in this fork; keep them green when touching sample policies.
